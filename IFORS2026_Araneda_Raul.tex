...
\begin{frame}{Objective}
	\justifying
	Design, formulate, and evaluate a prescriptive decision-support framework for capacity planning in Minimally Invasive Gynecology.
\end{frame}
...
\begin{frame}{Methods selected}
	...
	\resizebox{0.55\textwidth}{!}{%
		\begin{tabular}{lc}
			...
			& SK-Adaptive \\
			& \textbf{SMAC-SK}\,\textcolor{okgreen}{$\bigstar$} \\
			& SK-KGCP \\
			\bottomrule
	\end{tabular}}
\end{frame}
...
\begin{frame}{Results}
	\justifying
	\begin{itemize}[<+->]
		\item \textbf{Main result:} Best algorithms reduced TTS from
		\textbf{263 to 174 days} ($-34\%$) while patients served
		increased from \textbf{1{,}148 to 2{,}200+} ($+91\%$).

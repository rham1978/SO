"""
===============================================================================
MÓDULO 11 — ASTRO-DF: Adaptive Sampling Trust-Region Derivative-Free
===============================================================================
Implementa el algoritmo ASTRO-DF de Shashaani, Hashemi & Pasupathy (2016)
adaptado al simulador DES clínico.

Referencia:
  Shashaani, S., Hashemi, F.S., Pasupathy, R. (2016). "ASTRO-DF: A Class of
  Adaptive Sampling Trust-Region Algorithms for Derivative-Free Stochastic
  Optimization." arXiv:1610.06506.

Diferencia fundamental con módulos 7-10 (SMAC/Bayesian global):
  M7-10: Optimización bayesiana GLOBAL — surrogate SK/GP cubre todo el espacio
         de 12 dimensiones, propone candidatos mediante EI/KGCP.
  M11:   Trust-region LOCAL — modelo lineal estocástico en B(Xk; Δk),
         optimizado localmente, avanza iterativamente hacia punto crítico.
         Convergencia wp1 garantizada (Teorema 5.6 del paper).

Muestreo adaptativo (eq. 4.1 del paper):
  Ñk+1 = max{λk, min{n : σ̂F(x,n)/√n ≤ κoas·Δk²/√λk}}
  Más réplicas cuando Δk pequeño (cerca del óptimo), menos cuando lejos.

Uso recomendado:
  1. Correr M10 (KGCP global) para encontrar zona prometedora
  2. Pasar incumbente de M10 como punto inicial de M11
  3. M11 refina localmente con convergencia certificada

Indicador fijo : tts_full_days_mean
Gráficos       : convergencia + tiempo + réplicas adaptativas + Δ trust-region
Paralelismo    : réplicas de cada punto se ejecutan con ProcessPoolExecutor

Uso:
  python modulo11_astro_df.py --n_iter 150
  python modulo11_astro_df.py --incumbente resultado_m10_hpo_kgcp.json
  python modulo11_astro_df.py --n_iter 200 --n_workers 4 --delta0 0.3
===============================================================================
"""
...
# ══════════════════════════════════════════════════════════════════════════════
# MÓDULO 11 — ASTRO-DF (Adaptive Sampling Trust-Region Derivative-Free)
# Implementación directa de Algoritmos 1 y 2 del paper (arXiv:1610.06506)
# ══════════════════════════════════════════════════════════════════════════════
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Módulo 11: ASTRO-DF — Adaptive Sampling Trust-Region Derivative-Free"
    )
    # ── Punto inicial ────────────────────────────────────────
